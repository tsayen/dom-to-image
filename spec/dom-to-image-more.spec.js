        ...
        describe('regression', function () {
            ...
            it('should preserve content of ::before and ::after pseudo elements', function (done) {
                ...
                loadTestPage('pseudo/dom-node.html', 'pseudo/style.css', undefined)
                    .then(renderToPng)
                    .then(drawDataUrl)
                    .then(assertTextRendered(["Before 2", "3 Just", "Before 4"]))
                    .then(done).catch(done);
            });
            ...
            it('should render background images', function (done) {
                this.timeout(10000);
                loadTestPage('css-bg/dom-node.html', 'css-bg/style.css', 'css-bg/control-image')
                    .then(renderAndCheck)
                    .then(done).catch(done);
            });
            ...
            it('should apply handle background-clip:text', function (done) {
                loadTestPage('background-clip/dom-node.html', 'background-clip/style.css', 'background-clip/control-image')
                    .then(function () {
                        return domtoimage.toPng(domNode());
                    })
                    .then(check)
